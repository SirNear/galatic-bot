    ...
    async run(interaction) {
        try {
            if (interaction.isChatInputCommand()) {
                ...
                } else if (customId.startsWith('edit_appearance_') || customId.startsWith('delete_appearance_') || customId.startsWith('confirm_delete_ap_') || customId.startsWith('modal_edit_appearance_')) {
                    await handleAppearanceInteraction(interaction, this.client);
                } else if (customId.startsWith('loja') || customId.startsWith('approve_loja_') || customId.startsWith('reject_loja_')) {
