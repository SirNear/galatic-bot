...
module.exports = (client) => {
    ...
    setInterval(async () => {
        try {
            ...
            const filaChannel = await client.channels.fetch('1502919601107763252').catch(() => null);
            const pendentAdmChannel = await client.channels.fetch('1502919510787887104').catch(() => null);
