...
module.exports = class ajuda extends Command {
	...
	message.reply('**Verifique sua DM**')
	     message.author.send('[CLIQUE AQUI PARA ADICIONAR O BOT EM SEU SERVIDOR](https://discord.com/oauth2/authorize?client_id=INSERT_CLIENT_ID_HERE&scope=bot&permissions=8')
}).catch(() => {
